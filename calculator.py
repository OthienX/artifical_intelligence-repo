...
class MainApp(App):
    ...
    def on_button_press(self, instance):
        ...
        #else:
            #if current and (
                ## no two operators in the screen 
                #self.last_was_operator and button_text in self.operators):
                #return
            #elif current == '' and button_text in self.operators and button_text != 'C':
            #    return
        else:
                current = self.solution.text
                new_text = current + button_text.text
